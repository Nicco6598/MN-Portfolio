...
import '../styles/animations.css'; // Assicurati di creare un file animations.css per le animazioni

const Home: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto p-12 bg-gradient-to-r from-blue-50 to-indigo-50 bg-opacity-80 backdrop-blur-lg mt-12 rounded-xl shadow-[inset_0px_0px_30px_0px_#00000024]">
